...
###import file#######
# from augmentation import crop_img_bboxes
...
if __name__ == '__main__':
    ...
    dataloader = Synth80k('../vn_syn_data_craft', target_size = 768)
    ...
    #print(input.size())
    net = CRAFT()
    net.load_state_dict(copyStateDict(torch.load('./pretrain/craft_pretrain/synweights_2021-04-19 09:27:18.892259_90000.pth')))
    ...
    logFile = LogTrain('./basenet/')
    criterion = Maploss(logFile)
    ...
    for epoch in range(1000):
        ...
        for index, (images, gh_label, gah_label, mask, _) in enumerate(train_loader):
            ...
            if index % 5000 == 0 and index != 0:
                ...
                torch.save(net.module.state_dict(),
                           './pretrain/craft_pretrain/synweights_' + str(datetime.now()) + '_' + repr(index) + '.pth')
                # test('./basenet/synweights_' + repr(index) + '.pth')
